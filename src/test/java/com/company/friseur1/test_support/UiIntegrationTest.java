package com.company.friseur1.test_support;

import com.company.friseur1.Friseur1Application;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.friseur1.screen")
@ContextConfiguration(classes = {Friseur1Application.class, UiTestAssistConfiguration.class})
